  ...
  return emailBase(`
    ...
    <div style="margin:2rem 0;">
      ...
      <ul style="line-height:1.8;margin-left:1.5rem;color:#142032;">
        ${primaryProfile.stress.map(s => `<li style="color:#142032;font-size:.95rem;">${s}</li>`).join('')}
      </ul>
    ...
    <div style="margin:2rem 0;">
      ...
      <ul style="line-height:1.8;margin-left:1.5rem;color:#142032;">
        ${primaryProfile.strengths.map(s => `<li style="color:#142032;font-size:.95rem;">${s}</li>`).join('')}
      </ul>
      
      <h3 style="font-size:1.1rem;margin:1.5rem 0 .75rem;color:#C47E0A;">Areas for Development</h3>
      <ul style="line-height:1.8;margin-left:1.5rem;color:#142032;">
        ${primaryProfile.growth.map(g => `<li style="color:#142032;font-size:.95rem;">${g}</li>`).join('')}
      </ul>
